"""dough_dreamery_17994 URL Configuration
...
admin.site.site_header = "Dough Dreamery"
admin.site.site_title = "Dough Dreamery Admin Portal"
admin.site.index_title = "Dough Dreamery Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Dough Dreamery API",
        default_version="v1",
        description="API documentation for Dough Dreamery App",
    ),
    public=True,
